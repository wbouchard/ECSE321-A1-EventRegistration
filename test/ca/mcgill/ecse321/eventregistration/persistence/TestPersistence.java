...
public class TestPersistence {
	...
	public void setUp() throws Exception {
		...
		// create participants
		Participant pa  = new Participant("Hanz");
		Participant pa2 = new Participant("Fritz");
	...
	public void test() {
		...
		assertEquals("Hanz", rm.getParticipant(0).getName());
		assertEquals("Fritz", rm.getParticipant(1).getName());
